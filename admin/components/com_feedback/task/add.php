...
<div class="body">
    ...
    <div class="com_header color">
      <i class="fa fa-plus-circle" aria-hidden="true"></i> Thêm mới cảm nhận khách hàng
            ...
            <div class="tab-pane fade active in" id="info">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="txt_comment" class="form-control" id="txt_comment" placeholder="Nội dung comment">
                        </div>
                        <div class="clearfix"></div>
                    </div>
