	...
	<div class='col-md-12 body_col_right'>
        <div class='row'>
            <div class="com_header color">
                <i class="fa fa-list" aria-hidden="true"></i> Cập nhật thư viện ảnh
                ...
                <div class="col-md-6">
                    <form id="frm_action" name="frm_action" method="post" action=""  enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="txt_name" class="form-control" id="txt_name" value="<?php echo stripslashes($row['name']);?>" placeholder="">
						...
						<div class='form-group row'>
							...
							<div class="col-sm-9">
								<div class="row">
									...
									<div class="col-sm-3">
										<a class="btn btn-success" href="#" onclick="OpenPopup('<?php echo ROOTHOST;?>extensions/upload_image.php');"><b style="margin-top: 15px">Chọn</b></a>
									</div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="txt_intro" id="txt_intro" style="min-height: 80px" class="form-control"><?php echo stripslashes($row['intro']);?></textarea>
                        </div>
